...
@section('title', 'Create Import Data')
                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description"> Create Import Data <i class="fa-solid fa-gear fa-sm"></i> </p>
                            <form class="forms-sample" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Amount"
                                        name="amount_product">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail3">Staff</label>
                                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Staff"
                                        name="staff" value="{{ Auth::user()->name }}">
                                </div>
                            ...
                            <br>
                            <a href="{{ route('import.index') }}"><button class="btn btn-light">Back</button></a>
                        </div>
                    </div>
                </div>
            </div>
