            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('brand.update', $brand->id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            <p class="card-description"> Brand Update <i class="fa-sharp fa-solid fa-pen"></i> </p>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" placeholder="Description" name="description" style="height:130px">
                                                {{ $brand->description }}
                                            </textarea>
                                        </div>
                                    </div>
