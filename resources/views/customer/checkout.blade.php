...
@section('content')
    <div class="breadcumb_area bg-img" style="background-image: url(image/bG/breadcumb.jpg);">
                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="postcode" value="" name="email">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="city">Phone No <span>*</span></label>
                                    <input type="text" class="form-control" id="city" value="" name="phone">
                                </div>
                                {{-- <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-4">
                                    <label for="email_address">Message <span>*</span></label>
                                    <input type="text" class="form-control" id="email_address" value=""
                                        name="message">
                                </div>
                                {{-- <div class="col-12">
                        ...
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                @foreach ($cartItems as $data)
                                    <li><span style="color: #0315ff">{{ $data->product->product_name }} x
                                            {{ $data->product_amount }}</span>
                                        <span>${{ $data->product->product_price * $data->product_amount }}</span></li>
                                @endforeach
                                <li><span>Subtotal</span> <span>${{ $total }}</span></li>
                                <li><span>Shipping</span> <span>Free</span></li>
                                <li><span style="color:#ff084e">Total</span> <span
                                        style="color:#ff084e">${{ $percent_15 }}</span></li>
                            </ul>
                            <div id="accordion" role="tablist" class="mb-4">
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingOne">
                                        ...
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            <input type="radio" class="custom-control-input" id="customCheck1" name="payment_type" value="Cod" checked>
                                            <label class="custom-control-label" for="customCheck1">Cod</label>
                                        </div>
                                    {{-- <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin pharetra
                                                tempor so
                                                dales. Phasellus sagittis auctor gravida. Integ er bibendum sodales arcu id
                                                te
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingTwo">
                                        ...
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            <input type="radio" class="custom-control-input" id="customCheck2" name="payment_type" value="MoMo">
                                            <label class="custom-control-label" for="customCheck2">MoMo</label>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingThree">
                                        ...
                                        <div class="custom-control custom-checkbox d-block">
                                            <input type="radio" class="custom-control-input" id="customCheck3" name="payment_type" value="Vnpay">
                                            <label class="custom-control-label" for="customCheck3">Vnpay</label>
                                        </div>
                                    </div>
